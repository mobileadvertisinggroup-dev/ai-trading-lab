...
Version: FINAL-1.2 (consolidated, post-audit; Engine v7 differential gate replaced by the Independent Reference Ledger differential gate per explicit user authorization, 2026-08-25)
Status: APPROVED FOR IMPLEMENTATION
Supersedes: FINAL-1.1 and all prior drafts, amendments, and review correspondence. FINAL-1.1 is preserved unchanged as SPEC_FINAL-1.1.md for audit history. No other document is binding.
